...
- **Single flight** — fight through five themed stages of increasing difficulty: **Daybreak**, **Sunset Squadron**, **Night Raid** (moonlit, starry), **Storm Front** (rain and lightning), and **Deep Space** (asteroids, green enemy lasers, a ringed planet). Each stage spawns faster, tougher, more accurate enemies, and a **stage guardian boss** attacks at every stage transition — beat it for big points and a repair drop. Grab floating power-ups (**shield**, **triple shot**, **repair**), chain hits for a score multiplier, and beat your personal best (saved locally).
